...
WITH employees AS (
    SELECT 'Sales' AS department, 'John' AS emp_name, 5000 AS salary FROM dual
    UNION ALL SELECT 'Sales', 'Jane', 7000 FROM dual
    UNION ALL SELECT 'HR', 'Peter', 4500 FROM dual
    UNION ALL SELECT 'HR', 'Mary', 8000 FROM dual
),
