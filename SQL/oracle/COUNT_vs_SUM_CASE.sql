-- Oracle 데이터 타입에 맞게 수정 (VARCHAR -> VARCHAR2, INT -> INTEGER, DECIMAL -> NUMBER)
CREATE TABLE orders (
    order_id INTEGER,
...
-- 데이터 삽입
-- Oracle에서는 다중 INSERT를 위해 각 VALUES 절 앞에 INSERT ALL을 사용하거나, 각 행마다 INSERT 문을 사용해야 합니다.
-- 여기서는 개별 INSERT 문으로 변환합니다.
INSERT INTO orders (order_id, category, amount, status) VALUES (1, '전자제품', 1200.00, '정상');
INSERT INTO orders (order_id, category, amount, status) VALUES (2, '의류', 50.00, '정상');
INSERT INTO orders (order_id, category, amount, status) VALUES (3, '전자제품', 800.00, '환불');
INSERT INTO orders (order_id, category, amount, status) VALUES (4, '도서', 25.00, '정상');
INSERT INTO orders (order_id, category, amount, status) VALUES (5, '전자제품', 1500.00, '정상');
...
-- --- 야구 데이터 예시 ---
-- Oracle에서는 컬럼 별칭에 공백이 있을 경우 큰따옴표("")를 사용합니다.
